...
import { X, LogOut, Award, CookingPot, BookOpen, ThumbsUp } from 'lucide-react';
            ...
            {mealLog.length > 0 ? (
                <div className="space-y-3">
                    {mealLog.slice(0, 5).map(meal => (
                        <div key={meal.id} className="bg-brand-surface p-2.5 rounded-xl shadow-sm flex items-center justify-between gap-3">
                            <div className="flex items-center gap-3">
                                {meal.imageUrl ? (
